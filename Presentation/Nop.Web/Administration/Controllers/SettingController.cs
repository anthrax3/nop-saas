...
using Digital.Services.Security;
...
namespace Nop.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
	{
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageBlogSettings))
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageVendorSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageForumSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageNewsSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageShippingSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageTaxSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageCatalogSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageRewardPointsSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageOrderSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageShoppingCartSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageMediaSettings))
                return AccessDeniedView();
        ...
        {
            if (!_permissionService.Authorize(DigitalPermissionProvider.ManageAllSettings))
                return AccessDeniedView();
